...
- Какое участие может принять взаимодействии этих микросервисов с RPC?
...
- Нужно микосервисы объединить каким то API Gateway или можно на уровне клиента сделать?
